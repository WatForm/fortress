...
class Z3ApiInterpretation(model: Z3Model, sig: Signature, skolemConstantMapping: Map[String, AnnotatedVar], converter: TheoryToZ3_StringParse, context: Z3Context, sortMappings: Map[Z3Expr, DomainElement]) extends Interpretation {

    def this(model: Z3Model, sig: Signature, skolemConstantMapping: Map[String, AnnotatedVar], converter: TheoryToZ3_StringParse, context: Z3Context) = this(model, sig, skolemConstantMapping, converter, context, (
        for {
