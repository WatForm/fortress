...
class ClosureEliminatorTests {
    trait CEBehaviors{ this: AnyFlatSpec =>
    ...
    class ClosureEliminatorEijckTest extends AnyFlatSpec with CEBehaviors {
        "CEEijck" should behave like AnyClosureEliminator(ClosureEliminatorEijck)
    }
}
