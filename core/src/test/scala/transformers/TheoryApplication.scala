...
class TheoryApplication(baseTransformer: ProblemStateTransformer) extends ProblemStateTransformer {
    def apply(problemState: ProblemState): ProblemState = baseTransformer.apply(problemState)
