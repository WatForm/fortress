...
//         Errors.Internal.assertion(matches.size <= 1, "Found multiple matches to function " + name + ": " + argSorts)
...
//         Errors.Internal.assertion(matches.size <= 1, "Found multiple matches for constant " + v.name)
//         if(matches.nonEmpty) Some(matches.head)
...
//         Errors.Internal.assertion(matches.size <= 1, "Found multiple matches for enum " + e.name)
//         if(matches.nonEmpty) Some(matches.head)
...
//         Errors.Internal.assertion(matches.size <= 1, "Found multiple matches for function " + name)
//         if(matches.nonEmpty) Some(matches.head)
