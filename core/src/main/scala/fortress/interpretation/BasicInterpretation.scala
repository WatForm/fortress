...
class BasicInterpretation(
    ...
    override val functionInterpretations: Map[FuncDecl, FunctionInterpretation],
...
object BasicInterpretation {
    def apply(sortInterpretations: Map[Sort, Seq[Value]],
              ...
              functionInterpretations: Map[FuncDecl, FunctionInterpretation],
    ...
    def mkBasicInterpretation(
         ...
         functionInterpretations: java.util.Map[FuncDecl, FunctionInterpretation],
